...
public class DatePickerDialog extends DialogFragment implements
    ...
    private int neutralButtonVisibility = View.INVISIBLE;
    private NeutralClickListener neutralButtonListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        neutralButton = (Button) view.findViewById(R.id.mdtp_neutral);
        ...
        neutralButton.setTypeface(TypefaceHelper.get(activity, "Roboto-Medium"));
        neutralButton.setVisibility(neutralButtonVisibility);
        if (mNeutralString != null) {
            neutralButton.setText(mNeutralString);
        }
    ...
    public void setNeutralButton(String neutralString, int visibility, NeutralClickListener listener) {
        setNeutralString(neutralString);
        setNeutralButtonVisibility(visibility);
        setNeutralButtonListener(listener);
    }

    private void setNeutralButtonListener(final NeutralClickListener listener) {
    ...
    public void setNeutralString(String neutralString) {
        if (neutralButton != null) {
    ...
    public void setNeutralButtonVisibility(int visibility) {
        if (neutralButton != null) {
            neutralButton.setVisibility(visibility);
        } else {
            neutralButtonVisibility = visibility;
        }
    }
